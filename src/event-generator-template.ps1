...
$a.resources[0].properties.parameters.'$connections'.value.azureloganalyticsdatacollector.connectionId = "[concat('/subscriptions/cf75ef66-7f08-4f44-889f-e77aabbab3eb/resourceGroups/', parameters('resourceGroupPrefix'), '-cdcaeg/providers/Microsoft.Web/connections/', parameters('resourceGroupPrefix'), '-logapi-01')]"
